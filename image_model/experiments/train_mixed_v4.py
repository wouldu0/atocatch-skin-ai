# ============================================================
# 혼합 데이터 학습 v4 — 아토피 정제 버전 (preprocess_v2.py 산출물)
# EfficientNetV2-S | Optuna 튜닝 적용 버전
#
# v3과 차이점:
#   CSV_PATH → skin_disease_mixed_v2.csv (아토피 필터 적용)
...
print(f"\nTrain: {len(train_df)}장  |  Val: {len(val_df)}장  |  Test: {len(test_df)}장")
print("\n[Train] 소스별 분포:")
...
plt.suptitle(f"EfficientNetV2-S v4 (아토피 정제) | Best Val Acc: {best_val_acc:.4f}", fontsize=13)
plt.tight_layout()
...
print("\n다음 단계: evaluate_test_mixed_v4.py 실행")

# ============================================================
# 최종 테스트 평가 v4 — 아토피 정제 버전
# 1) AI Hub test  (합성 이미지)
# 2) DermNet test (실제 이미지)
# 3) 전체 test    (합산)
# ============================================================
import os
import numpy as np
...
plt.suptitle("혼합 모델 최종 테스트 평가 (v4 아토피 정제)", fontsize=14, fontweight="bold")
plt.tight_layout()
...
ax.set_title("클래스별 정확도 비교: 합성 vs 실제 이미지 (v4)", fontsize=13, fontweight="bold")
